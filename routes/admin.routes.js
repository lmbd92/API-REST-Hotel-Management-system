...
module.exports = (app) => {
  ...
  app.post("/api/guest", auth, (req, res) => {
    ...
    sql.query(
      adminQueries.createGuest(phone, firstName, lastName, dob),
      (err, resp) => {
        if (err) {
          res.statusMessage = err.sqlMessage;
          res.status(400).end();
  ...
  app.post("/api/assignGuest", (req, res) => {
    ...
    sql.query(
      adminQueries.assignGuest(reservationId, phone, firstName, lastName, dob),
      (err, resp) => {
        if (err) {
          res.statusMessage = err.sqlMessage;
          res.status(400).end();
  ...
  app.get("/api/reservation/guests", (req, res) => {
    ...
    sql.query(
      adminQueries.getGuestsForReservation(reservationId),
      (err, resp) => {
        if (err) {
          res.statusMessage = err.sqlMessage;
          res.status(400).end();
  ...
  app.delete("/api/guest", (req, res) => {
    ...
    sql.query(
      adminQueries.deleteGuest(phone, firstName, lastName, dob),
      (err, resp) => {
        if (err) {
          res.statusMessage = err.sqlMessage;
          res.status(400).end();
  ...
  app.post("/api/dates", (req, res) => {
    ...
    sql.query(
      adminQueries.makeDatesInRange(startDate, endDate),
      (err, resp) => {
        if (err) {
          res.statusMessage = err.sqlMessage;
          res.status(400).end();
  ...
  app.get("/api/roomDates", (req, res) => {
    ...
    sql.query(
      adminQueries.getRoomDates(startDate, endDate, propertyName),
      (err, resp) => {
        if (err) {
          res.statusMessage = err.sqlMessage;
          res.status(400).end();
